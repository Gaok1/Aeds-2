...
char *readStr();  // le uma string do console ate um espaço ou um \n, \t ou EOF
...
char *askStr(const char *question, ...);     // escreve uma string no console e le uma string do console ate um espaço ou um \n ou \t
...
char *askStr(const char *question, ...)
{
    println(question);
    char *buffer = readStr();
    return buffer;
